...
namespace Hermes.Service.Device.Api.Application.Command.PlatformCommand
{
    ...
    /// 平台响应数据命令处理器
    /// </summary>
    public class PlatformRespondsDataCommandHandler : CommunicationCommandHandler<PlatformRespondsDataCommand>
    {
        /// <summary>
        /// Mqtt 连接查询
        /// </summary>
        ...
        /// 日志器
        /// </summary>
        private readonly ILogger<PlatformRespondsDataCommandHandler> logger;
        ...
        public PlatformRespondsDataCommandHandler(IMqttConnectionQuery mqttConnectionQuery, ILogger<PlatformRespondsDataCommandHandler> logger, IMediator mediator)
        {
        ...
        /// 异步处理平台响应数据命令
        /// </summary>
        /// <param name="request">平台响应数据命令</param>
        /// <param name="cancellationToken">取消令牌</param>
        /// <returns></returns>
        public override async Task Handle(PlatformRespondsDataCommand request, CancellationToken cancellationToken)
        {
            try
            {
